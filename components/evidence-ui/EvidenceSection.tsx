  ...
  return (
    <section className={evidenceUiTokens.section} aria-labelledby={`${baseId}-title`}>
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 id={`${baseId}-title`} className="rw3-title">
            {bundle.title}
          </h2>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            className={`${evidenceUiTokens.touchTarget} rw3-ghost`}
            aria-expanded={open}
      ...
      {open ? (
        <div id={`${baseId}-body`} className="mt-6 space-y-6">
          ...
          {splitMetric?.split ? (
            <div id={`${baseId}-split`}>
              <h3 className="text-[14px] font-semibold">Home / Away</h3>
              <div className="mt-3">
                <SplitCard
          ...
          {baselineMetric?.baseline ? (
            <div id={`${baseId}-baseline`}>
              <h3 className="text-[14px] font-semibold">Baseline</h3>
              <div className="mt-3">
