export const predictionsEn = {
  ...
  /* Nav + chrome strings — language sweep (nv keys). Reused elsewhere:
     navMethodology, opIndexTitle, cmpIndexTitle, tmIndexTitle, cmpSeasonsTitle, srchTitle. */
  nvHome: "Home",
  nvGroupResearch: "Research",
  nvGroupReference: "Reference",
  nvToday: "Today's fixtures",
  nvArchive: "Archive",
  nvAccas: "Accumulators",
  nvAccasPublished: "Published accumulators",
  nvAccaBuild: "Build accumulator",
  nvQualifiedFixtures: "Qualified fixtures",
  nvLiveMatches: "Live matches",
  nvShortlist: "Shortlist",
  nvMarkets: "Markets",
  nvCountries: "Countries",
  nvFixtures: "Fixtures",
  nvSettledRecord: "Settled record",
  /* Acca studio panel — language sweep block 3 (app keys). */
  appTitle: "Your Acca",
  appCountLine: "{n} selections · research slip only",
  appCloseAria: "Close Acca panel",
  appDismiss: "Dismiss",
  appUndo: "Undo",
  appClearAll: "Clear all",
  appCleared: "Acca cleared.",
  appOpenStudio: "Open studio",
  appEmptySlip:
    "Add selections from match pages, ranked markets, or the fixture explorer. Only settlement-supported markets are available.",
  appOddsUnavailable: "odds unavailable",
  appProviderPotential: "provider potential {pct}% (no sample)",
  appMatchDetail: "Match detail",
  appRemove: "Remove",
  appRemoveAria: "Remove {home} vs {away}",
  appCombinedOdds: "Combined odds",
  appIncomplete: "incomplete",
  appRiskClass: "Risk class",
  appStakeUnits: "Stake (units)",
  appPotentialReturn: "Potential return",
  appPotentialProfit: "Potential profit",
  appUnitsNote:
    "Units are currency-neutral research figures — not a wallet and not a placed bet.",
  appNameLabel: "Name this Acca",
  appNamePlaceholder: "e.g. Saturday overs",
  appSaveNamed: "Save named Acca",
  appSavedLocally: "Saved locally.",
  appCopy: "Copy",
  appCopied: "Copied as text.",
  appTelegramText: "Telegram text",
  appTelegramCopied: "Telegram-friendly text copied.",
  appShareUrl: "Share URL",
  appShareCopied: "Share URL copied (noindex restore link).",
  appClipboardUnavailable: "Clipboard unavailable.",
  appSavedAccas: "Saved Accas",
  appDelete: "Delete",
  appDeleteAria: "Delete {name}",
  /* Acca builder — language sweep block 3 (apb keys). */
  apbConfigTitle: "Builder configuration",
  apbRiskMode: "Risk mode",
  apbAllowedMarkets: "Allowed markets",
  apbTargetMin: "Target odds min (optional)",
  apbTargetMax: "Target odds max (optional)",
  apbExcludeTeams: "Exclude teams (comma-separated)",
  apbCompetitionFilter: "Competition filter (comma-separated, optional)",
  apbOnePerFixture: "One selection per fixture",
  apbPrematchOnly: "Pre-match only",
  apbGenerate: "Generate Acca",
  apbGenerating: "Generating…",
  apbGeneratingLong: "Generating accumulator suggestions…",
  apbIdleNote:
    "Configure filters, then generate. Combinations use real published list predictions — never invented fixtures or odds.",
  apbRanked: "Ranked combinations",
  apbNoCombo:
    "No valid combination for this configuration. Relax confidence, markets, or leg count — quality gates are not lowered automatically.",
  apbGenerationFailed: "Generation failed.",
  apbTimeout: "Provider request timed out. Try again.",
  apbNetworkFail: "Network failure — check your connection and try again.",
  apbRecommended: "Recommended",
  apbSafer: "Safer alternative",
  apbHigherRisk: "Higher-risk alternative",
  apbOddsUnavailable: "Odds unavailable",
  apbAddAll: "Add entire Acca to Studio",
  apbAddOne: "Add to accumulators",
  apbReplace: "Replace",
  apbCancel: "Cancel",
  apbWhyLeg: "Why this leg",
  apbWarningsAria: "Warnings",
  apbAccasUnavailable: "Accumulators are unavailable in this view. Open accumulators first.",
  apbOpenAccas: "Open accumulators",
  /* Public acca pages — language sweep block 3 (apx/apd/aps keys). */
  apxLede:
    "Multi-selection combinations assembled from our qualified fixture lists, published with their evidence.",
  apxLede2:
    "Each one is a deterministic combination of selections that already qualified for our published lists — never a hand-picked selection, and never re-scored after the fact. Its page states which selections it contains, what was recorded in support of each, when it was generated and published, and whether its fixtures have kicked off.",
  apxStillAhead: "Still ahead",
  apxStillAheadNote: "Newest first. At least one fixture in each of these has not kicked off.",
  apxSettledNote:
    "Every fixture in these has kicked off. They stay published as a record of what was said beforehand. Outcomes are not recorded on an Acca page — settled single predictions live in the archive.",
  apxNothingFilter: "Nothing matches that filter",
  apxNothingYet: "Nothing published yet",
  ...
  apxOlderNote:
    "This listing examines the most recent {n} published Accas for this language. Older ones exist in storage and are not shown here.",
  apxClosed: "Closed",
  apxTodaysListsNote: "— the lists these are built from.",
  apxBuilderNote: "— assemble your own from the same evidence.",
  apxArchiveNote: "— settled results, wins and losses alike.",
  apxHowBuilt: "How these are built",
  apxFirstKickoff: "First kick-off",
  apxLimitationsNoted: "{n} limitations noted — see the full breakdown.",
  apxFilterState: "State",
  apxPagesAria: "Published Acca pages",
  apxFullBreakdown: "the full breakdown",
  apxFilterProfile: "Profile",
  apxFilterCompetition: "Competition",
  apdAtAGlance: "At a glance",
  apdSelections: "Selections",
  apdBuilderProfile: "Builder profile",
  apdGenerated: "Generated",
  apdPublished: "Published",
  apdState: "State",
  apdSelectionsTitle: "The {n} selections",
  apdTableCaption: "Selections in this Acca, with the odds captured at publication",
  apdColFixture: "Fixture",
  apdColKickoff: "Kick-off (UTC)",
  apdColEvidence: "Evidence",
  apdColPotential: "Provider potential",
  apdColOddsAtPub: "Odds at publication",
  apdCombinedNote:
    "Combined odds are the product of the individual prices above, calculated exactly and rounded once. They are not a probability and not a return estimate.",
  apdWhyTitle: "Why these selections",
  apdWhyNote:
    "Every selection below already qualified for our published fixture lists before the Builder combined it. Expand one to see exactly what was recorded for it at the time. A selection with nothing recorded says so — an empty panel is a gap in the record, not a silent endorsement.",
  apdQualification: "Qualification",
  apdQualifiedLine:
    "Passed the Builder's confidence, freshness, conflict and evidence gates when the combination was generated.",
  apdPriceRecorded: "Price recorded",
  apdProvenance: "Provenance",
  apdBuiltOn: "What this was built on",
  apdNoAggregateNotes: "No aggregate evidence notes were recorded for this combination.",
  apdWithPotential: "Selections with a provider potential",
  apdAvgPotential: "Average provider potential",
  apdCompleteness: "Evidence completeness",
  apdProvenanceTitle: "Provenance and data freshness",
  apdWithReasons: "Selections with written reasons",
  apdOddsCaptured: "Odds captured",
  apdPriceAge: "Price age",
  apdPublicationFormat: "Publication format",
  apdOfCount: "{a} of {b}",
  apsLinkCopied: "Link copied to the clipboard.",
  apsClipboardManual:
    "The clipboard is not available here. The link is selected — copy it manually.",
  apsShareSheetOpened: "Share sheet opened.",
  navQualified: "Qualified lists",
  navLiveSignals: "Live signals",
  navMethodology: "Methodology",
  navOperators: "Operators",
  /* V3 reskin — session 1 (v3 keys). */
  v3NavPredictions: "Predictions",
  v3NavBettingTips: "Betting tips",
  v3NavBettingSites: "Betting sites",
  v3NavFreeBets: "Free bets",
  v3NavSites: "Sites",
  v3NavRecord: "Record",
  v3SignIn: "Sign in",
  v3SearchPlaceholder: "Team, league or market",
  v3PopularLeagues: "Popular leagues",
  v3AllMatches: "All matches",
  v3Sponsored18: "Sponsored · 18+",
  v3Best: "Best",
  v3Continue: "Continue",
  v3CommissionLine: "Terms apply. We earn commission from these links; it never affects the predictions.",
  v3VerifiedHitRate: "Verified hit rate",
  v3Season: "Season {season}",
  v3LockLine: "Every prediction locks at the final score.",
  v3SeeRecord: "See the record",
  v3HighPotentialToday: "High potential · today",
  v3NPredictions: "{n} predictions",
  v3OfferOfTheDay: "Offer of the day",
  v3Live: "Live",
  v3ViewAll: "View all",
  v3Today: "Today",
  v3Tomorrow: "Tomorrow",
  v3Weekend: "Weekend",
  v3AllMarkets: "All markets",
  v3SortByRate: "By rate",
  v3ColTime: "Time",
  v3ColMatch: "Match",
  v3ColLeague: "League",
  v3ColMarket: "Market",
  ...
  v3ColSample: "Sample",
  v3ColForm: "Form",
  v3ColBestOdds: "Best odds",
  v3NMoreMatches: "{n} more matches",
  v3OddsAsOf: "Odds as of {time}",
  v3SponsoredLinks: "Sponsored links · 18+",
  v3EditorPick: "Editor's pick",
  v3More: "more",
  v3EditorNote: "Editor's note",
  v3EmptyMatchesTitle: "No matches today",
  v3EmptyMatchesLine: "The pitch is empty today.",
  v3EmptyMatchesTomorrow: "Tomorrow has {n} matches — first kickoff {time}.",
  v3EmptyOffersTitle: "No offers in your country",
  v3EmptyOffersLine: "Nothing here yet; the predictions stay open to everyone.",
  v3EmptySnapshotTitle: "No snapshot yet",
  v3EmptySnapshotLine: "The model runs at {time}; until then we give no numbers.",
  v3EmptyEditorTitle: "Editor's picks are empty",
  v3EmptyEditorLine: "The band fills itself — the four strongest signals are live now.",
  v3NotFoundTitle: "Out of play",
  ...
  v3NoSample: "no sample",
  /* Fixture v3.1 — the match page's five layers (design/v3/match-v31.pdf). */
  v3FxVerdict: "Verdict",
  v3FxEvidence: "Evidence",
  v3FxHistory: "History",
  v3FxComparison: "Comparison",
  v3FxPlay: "Play",
  v3SampleStrength: "Sample strength",
  v3PpVsLeague: "{pp} pp vs league average",
  v3PlayThisMarket: "Play this market",
  v3TopPrice: "top price",
  v3LastFive: "Last 5",
  v3SnapshotLine: "Snapshot {time} · model {version} · {n} validations",
  v3DerivedLive: "No snapshot yet — derived live from the same inputs",
  v3SortedByDeviation: "Sorted by deviation · bar = rate · white line = league average",
  v3LeagueAvgIs: "league avg {pct}%",
  v3NMoreSignals: "{n} more signals",
  v3H2hTitle: "Head-to-head record",
  v3LastNMeetings: "Last {n} meetings · {from}–{to}",
  v3NWinsPct: "{n} wins · {pct}%",
  v3NDrawsPct: "{n} draws · {pct}%",
  v3CleanSheetFor: "{team} without conceding",
  v3ModelView: "The model's view",
  v3WhyMarket: "Why {market}, not the result",
  v3TplHomeGoals: "{team}'s home matches average {avg} goals.",
  v3TplAwayConceded: "{team} concede {avg} per away match.",
  v3TplLeagueGoals: "The league averages {avg} goals per match.",
  v3TplEarlyGoals: "A first-half goal landed in {pct}% of {team}'s home matches.",
  v3TplResultTight: "The result market is tighter: {team} won {pct}% of home matches.",
  v3Overall: "Overall",
  v3HomeShort: "Home",
  v3AwayShort: "Away",
  v3PtsPerMatch: "Pts/match",
  v3WinPct: "Win %",
  v3GoalsAvg: "Goals avg",
  v3ScoredAvg: "Scored",
  v3ConcededAvg: "Conceded",
  v3CleanSheetPct: "Clean sheets %",
  v3FailedToScorePct: "Failed to score %",
  v3LeadsRow: "Green = the side ahead on that row.",
  v3OperatorsMatchMarkets: "Operators · this match's markets",
  v3TopPriceOutline: "Green outline = the market's top price.",
  v3NoObservation: "no observation",
  v3MktOver35: "Over 3.5",
  v3MktCleanSheet: "Clean sheet",
  v3MktFailedToScore: "No goal scored",
