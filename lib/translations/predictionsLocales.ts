...
const pt: PredictionStrings = mergePredictions({
  ...
  v3NavPredictions: "Previsões",
  v3NavBettingTips: "Dicas de apostas",
  v3NavBettingSites: "Sites de apostas",
  v3NavFreeBets: "Apostas grátis",
  v3NavSites: "Sites",
  v3NavRecord: "Registro",
  v3SignIn: "Entrar",
  v3SearchPlaceholder: "Time, liga ou mercado",
  v3PopularLeagues: "Ligas populares",
  v3AllMatches: "Todos os jogos",
  v3Sponsored18: "Patrocinado · 18+",
  v3Best: "Top",
  v3Continue: "Continuar",
  v3CommissionLine: "Termos aplicáveis. Recebemos comissão por estes links; isso nunca afeta as previsões.",
  v3VerifiedHitRate: "Acerto verificado",
  v3Season: "Temporada {season}",
  v3LockLine: "Cada previsão trava no placar final.",
  v3SeeRecord: "Ver o registro",
  v3HighPotentialToday: "Alto potencial · hoje",
  v3NPredictions: "{n} previsões",
  v3OfferOfTheDay: "Oferta do dia",
  v3Live: "Ao vivo",
  v3ViewAll: "Ver tudo",
  v3Today: "Hoje",
  v3Tomorrow: "Amanhã",
  v3Weekend: "Fim de semana",
  v3AllMarkets: "Todos os mercados",
  v3SortByRate: "Por acerto",
  v3ColTime: "Hora",
  v3ColMatch: "Jogo",
  v3ColLeague: "Liga",
  v3ColMarket: "Mercado",
  ...
  v3ColSample: "Amostra",
  v3ColForm: "Forma",
  v3ColBestOdds: "Melhor odd",
  v3NMoreMatches: "Mais {n} jogos",
  v3OddsAsOf: "Odds às {time}",
  v3SponsoredLinks: "Links patrocinados · 18+",
  v3EditorPick: "Escolha do editor",
  v3More: "mais",
  v3EditorNote: "Nota do editor",
  v3EmptyMatchesTitle: "Sem jogos hoje",
  v3EmptyMatchesLine: "O campo está vazio hoje.",
  v3EmptyMatchesTomorrow: "Amanhã tem {n} jogos — primeiro apito às {time}.",
  v3EmptyOffersTitle: "Sem ofertas no seu país",
  v3EmptyOffersLine: "Nada por aqui ainda; as previsões seguem abertas para todos.",
  v3EmptySnapshotTitle: "Ainda sem snapshot",
  v3EmptySnapshotLine: "O modelo roda às {time}; até lá não damos números.",
  v3EmptyEditorTitle: "Seleção do editor vazia",
  v3EmptyEditorLine: "A faixa se preenche sozinha — os quatro sinais mais fortes já estão no ar.",
  v3NotFoundTitle: "Bola fora",
  v3NotFoundLine: "A bola saiu do campo. Vamos voltar à página inicial.",
  v3BackToPredictions: "Voltar às previsões de hoje",
  v3PlayResponsibly: "Jogue com responsabilidade",
  v3FreeBetsTitle: "Apostas grátis e ofertas",
  v3NActiveOffers: "{n} ofertas ativas",
  v3TermsAtOperator: "Os termos completos de cada oferta estão no operador.",
  v3OtherMarkets: "Outros mercados deste jogo",
  v3LeagueRates: "Taxas da liga · temporada até agora",
  v3NMatches: "{n} jogos",
  v3FormLast5: "Forma · últimos 5",
  v3H2hLast: "Confronto direto · últimos {n}",
  v3From: "De",
  v3To: "Até",
  v3SmallSample: "amostra pequena",
  v3NoSample: "sem amostra",
  v3FxVerdict: "Veredito",
  v3FxEvidence: "Evidências",
  v3FxHistory: "Histórico",
  v3FxComparison: "Comparação",
  v3FxPlay: "Jogar",
  v3SampleStrength: "Força da amostra",
  v3PpVsLeague: "{pp} p.p. vs média da liga",
  v3PlayThisMarket: "Jogar este mercado",
  v3TopPrice: "melhor cotação",
  v3LastFive: "Últimos 5",
  v3SnapshotLine: "Snapshot {time} · modelo {version} · {n} validações",
  v3DerivedLive: "Ainda sem snapshot — derivado ao vivo dos mesmos dados de entrada",
  v3SortedByDeviation: "Ordenado por desvio · barra = taxa · linha branca = média da liga",
  v3LeagueAvgIs: "média da liga {pct}%",
  v3NMoreSignals: "mais {n} sinais",
  v3H2hTitle: "Histórico do confronto direto",
  v3LastNMeetings: "Últimos {n} confrontos · {from}–{to}",
  v3NWinsPct: "{n} vitórias · {pct}%",
  v3NDrawsPct: "{n} empates · {pct}%",
  v3CleanSheetFor: "{team} sem sofrer gols",
  v3ModelView: "A visão do modelo",
  v3WhyMarket: "Por que {market}, e não o resultado",
  v3TplHomeGoals: "Os jogos de {team} em casa têm média de {avg} gols.",
  v3TplAwayConceded: "{team} sofre {avg} por jogo fora de casa.",
  v3TplLeagueGoals: "A liga tem média de {avg} gols por jogo.",
  v3TplEarlyGoals: "Saiu gol no primeiro tempo em {pct}% dos jogos de {team} em casa.",
  v3TplResultTight: "O mercado de resultado é mais apertado: {team} venceu {pct}% dos jogos em casa.",
  v3Overall: "Geral",
  v3HomeShort: "Casa",
  v3AwayShort: "Fora",
  v3PtsPerMatch: "Pts/jogo",
  v3WinPct: "Vitórias %",
  v3GoalsAvg: "Média de gols",
  v3ScoredAvg: "Marcados",
  v3ConcededAvg: "Sofridos",
  v3CleanSheetPct: "Sem sofrer gols %",
  v3FailedToScorePct: "Sem marcar %",
  v3LeadsRow: "Verde = o lado à frente naquela linha.",
  v3OperatorsMatchMarkets: "Operadores · mercados deste jogo",
  v3TopPriceOutline: "Contorno verde = melhor cotação do mercado.",
  v3NoObservation: "sem observação",
  v3MktOver35: "Mais de 3,5",
  v3MktCleanSheet: "Sem sofrer gols",
  v3MktFailedToScore: "Sem marcar",
  v3StrongestSignals: "Sinais mais fortes",
  v3MktOver15: "Mais de 1,5",
  v3MktOver25: "Mais de 2,5",
  v3MktUnder25: "Menos de 2,5",
  v3MktFh: "1ºT mais de 0,5",
  v3MktSh: "2ºT mais de 0,5",
  v3MktBtts: "Ambas marcam",
  v3MktBttsNo: "Ambas não marcam",
  v3MktHomeWin: "Vitória da casa",
  v3MktHomeUnbeaten: "Casa invicta",
  ...
  appTitle: "A tua Acca",
  appCountLine: "{n} seleções · apenas boletim de pesquisa",
  appCloseAria: "Fechar o painel da Acca",
  appDismiss: "Dispensar",
  appUndo: "Anular",
  appClearAll: "Limpar tudo",
  appCleared: "Acca limpa.",
  appOpenStudio: "Abrir estúdio",
  appEmptySlip:
    "Adiciona seleções a partir das páginas de jogo, dos mercados classificados ou do explorador de jogos. Só existem mercados com liquidação suportada.",
  appOddsUnavailable: "odds indisponíveis",
  appProviderPotential: "potencial do fornecedor {pct}% (sem amostra)",
  appMatchDetail: "Detalhe do jogo",
  appRemove: "Remover",
  appRemoveAria: "Remover {home} vs {away}",
  appCombinedOdds: "Odds combinadas",
  appIncomplete: "incompleto",
  appRiskClass: "Classe de risco",
  appStakeUnits: "Unidades (aposta base)",
  appPotentialReturn: "Retorno potencial",
  appPotentialProfit: "Lucro potencial",
  appUnitsNote:
    "As unidades são valores de pesquisa neutros — não uma carteira nem uma aposta feita.",
  appNameLabel: "Dá um nome a esta Acca",
  appNamePlaceholder: "p. ex. Overs de sábado",
  appSaveNamed: "Guardar Acca com nome",
  ...
  appShareUrl: "URL de partilha",
  appShareCopied: "URL copiado (ligação de restauro noindex).",
  appClipboardUnavailable: "Área de transferência indisponível.",
  appSavedAccas: "Accas guardadas",
  appDelete: "Eliminar",
  appDeleteAria: "Eliminar {name}",
  apbConfigTitle: "Configuração do construtor",
  apbRiskMode: "Modo de risco",
  apbAllowedMarkets: "Mercados permitidos",
  apbTargetMin: "Odd alvo mín. (opcional)",
  apbTargetMax: "Odd alvo máx. (opcional)",
  apbExcludeTeams: "Excluir equipas (separadas por vírgulas)",
  apbCompetitionFilter: "Filtro de competição (separado por vírgulas, opcional)",
  apbOnePerFixture: "Uma seleção por jogo",
  apbPrematchOnly: "Apenas pré-jogo",
  apbGenerate: "Gerar Acca",
  apbGenerating: "A gerar…",
  apbGeneratingLong: "A gerar sugestões de acumuladoras…",
  apbIdleNote:
    "Configura os filtros e gera. As combinações usam previsões publicadas reais — nunca jogos ou odds inventados.",
  apbRanked: "Combinações ordenadas",
  apbNoCombo:
    "Nenhuma combinação válida com esta configuração. Alivia a confiança, os mercados ou o número de seleções — as barreiras de qualidade não baixam automaticamente.",
  apbGenerationFailed: "A geração falhou.",
  apbTimeout: "O pedido ao fornecedor expirou. Tenta novamente.",
  apbNetworkFail: "Falha de rede — verifica a tua ligação e tenta de novo.",
  apbRecommended: "Recomendada",
  apbSafer: "Alternativa mais segura",
  apbHigherRisk: "Alternativa de maior risco",
  apbOddsUnavailable: "Odds indisponíveis",
  apbAddAll: "Adicionar a Acca inteira ao Studio",
  apbAddOne: "Adicionar às acumuladoras",
  apbReplace: "Substituir",
  apbCancel: "Cancelar",
  apbWhyLeg: "Porquê esta seleção",
  apbWarningsAria: "Avisos",
  apbAccasUnavailable:
    "As acumuladoras não estão disponíveis nesta vista. Abre primeiro as acumuladoras.",
  apbOpenAccas: "Abrir acumuladoras",
  apxLede:
    "Combinações de várias seleções montadas a partir das nossas listas qualificadas, publicadas com a sua evidência.",
  apxLede2:
    "Cada uma é uma combinação determinista de seleções que já qualificaram para as nossas listas publicadas — nunca uma escolha manual, e nunca repontuada depois. A sua página indica que seleções contém, o que ficou registado a favor de cada uma, quando foi gerada e publicada, e se os seus jogos já começaram.",
  apxStillAhead: "Ainda por vir",
  apxStillAheadNote: "As mais recentes primeiro. Pelo menos um jogo de cada ainda não começou.",
  apxSettledNote:
    "Todos os jogos destas já começaram. Continuam publicadas como registo do que foi dito de antemão. Os resultados não se anotam na página de uma Acca — as previsões individuais liquidadas vivem no arquivo.",
  apxNothingFilter: "Nada corresponde a esse filtro",
  apxNothingYet: "Ainda nada publicado",
  apxNothingFilterDesc:
    "Nenhuma Acca publicada corresponde aos filtros escolhidos. Limpa-os para veres tudo o que está publicado neste idioma.",
  apxNothingYetDesc:
    "Não foram publicadas Accas neste idioma. Em vez de encher com conteúdo de enchimento, a página fica vazia até haver algo real para mostrar.",
  apxOlderNote:
    "Esta listagem examina as {n} Accas publicadas mais recentes deste idioma. As mais antigas existem em armazenamento e não são mostradas aqui.",
  apxFullBreakdown: "a análise completa",
  apxFilterProfile: "Perfil",
  apxFilterCompetition: "Competição",
  apxClosed: "Fechadas",
  apxTodaysListsNote: "— as listas de onde estas são construídas.",
  apxBuilderNote: "— monta a tua com a mesma evidência.",
  apxArchiveNote: "— resultados liquidados, vitórias e derrotas por igual.",
  apxHowBuilt: "Como são construídas",
  apxFirstKickoff: "Primeiro pontapé de saída",
  apxLimitationsNoted: "{n} limitações anotadas — vê a análise completa.",
  apxFilterState: "Estado",
  apxPagesAria: "Páginas de Accas publicadas",
  apdAtAGlance: "Num relance",
  apdSelections: "Seleções",
  apdBuilderProfile: "Perfil do construtor",
  apdGenerated: "Gerada",
  apdPublished: "Publicada",
  apdState: "Estado",
  apdSelectionsTitle: "As {n} seleções",
  apdTableCaption: "Seleções desta Acca, com as odds captadas na publicação",
  apdColFixture: "Jogo",
  apdColKickoff: "Início (UTC)",
  apdColEvidence: "Evidência",
  apdColPotential: "Potencial do fornecedor",
  apdColOddsAtPub: "Odds na publicação",
  apdCombinedNote:
    "As odds combinadas são o produto dos preços individuais acima, calculado com exatidão e arredondado uma única vez. Não são uma probabilidade nem uma estimativa de retorno.",
  apdWhyTitle: "Porquê estas seleções",
  apdWhyNote:
    "Cada seleção abaixo já tinha qualificado para as nossas listas publicadas antes de o construtor a combinar. Expande uma para veres exatamente o que ficou registado na altura. Uma seleção sem nada registado di-lo — um painel vazio é uma lacuna no registo, não um aval silencioso.",
  apdQualification: "Qualificação",
  apdQualifiedLine:
    "Passou as barreiras de confiança, frescura, conflito e evidência do construtor quando a combinação foi gerada.",
  apdPriceRecorded: "Preço registado",
  apdProvenance: "Proveniência",
  apdBuiltOn: "Sobre o que foi construída",
  apdNoAggregateNotes: "Não foram registadas notas de evidência agregadas para esta combinação.",
  apdWithPotential: "Seleções com potencial do fornecedor",
  apdAvgPotential: "Potencial médio do fornecedor",
  apdCompleteness: "Completude da evidência",
  apdProvenanceTitle: "Proveniência e frescura dos dados",
  apdWithReasons: "Seleções com razões escritas",
  apdOddsCaptured: "Odds captadas",
  apdPriceAge: "Idade do preço",
  apdPublicationFormat: "Formato de publicação",
  apdOfCount: "{a} de {b}",
  apsLinkCopied: "Ligação copiada para a área de transferência.",
  apsClipboardManual:
    "A área de transferência não está disponível aqui. A ligação está selecionada — copia-a manualmente.",
  apsShareSheetOpened: "Folha de partilha aberta.",

});

const es: PredictionStrings = mergePredictions({
  /* V3 reskin — session 1 (v3 keys). */
  v3NavPredictions: "Predicciones",
  v3NavBettingTips: "Consejos de apuestas",
  v3NavBettingSites: "Casas de apuestas",
  v3NavFreeBets: "Apuestas gratis",
  v3NavSites: "Casas",
  v3NavRecord: "Registro",
  v3SignIn: "Iniciar sesión",
  v3SearchPlaceholder: "Equipo, liga o mercado",
  v3PopularLeagues: "Ligas populares",
  v3AllMatches: "Todos los partidos",
  v3Sponsored18: "Patrocinado · 18+",
  v3Best: "Top",
  v3Continue: "Continuar",
  v3CommissionLine: "Se aplican términos. Cobramos comisión por estos enlaces; nunca afecta a las predicciones.",
  v3VerifiedHitRate: "Acierto verificado",
  v3Season: "Temporada {season}",
  v3LockLine: "Cada predicción se cierra con el marcador final.",
  v3SeeRecord: "Ver el registro",
  v3HighPotentialToday: "Alto potencial · hoy",
  v3NPredictions: "{n} predicciones",
  v3OfferOfTheDay: "Oferta del día",
  v3Live: "En vivo",
  v3ViewAll: "Ver todo",
  v3Today: "Hoy",
  v3Tomorrow: "Mañana",
  v3Weekend: "Fin de semana",
  v3AllMarkets: "Todos los mercados",
  v3SortByRate: "Por acierto",
  v3ColTime: "Hora",
  v3ColMatch: "Partido",
  v3ColLeague: "Liga",
  v3ColMarket: "Mercado",
  ...
  v3ColSample: "Muestra",
  v3ColForm: "Forma",
  v3ColBestOdds: "Mejor cuota",
  v3NMoreMatches: "{n} partidos más",
  v3OddsAsOf: "Cuotas a las {time}",
  v3SponsoredLinks: "Enlaces patrocinados · 18+",
  v3EditorPick: "Selección del editor",
  v3More: "más",
  v3EditorNote: "Nota del editor",
  v3EmptyMatchesTitle: "Hoy no hay partidos",
  v3EmptyMatchesLine: "El campo está vacío hoy.",
  v3EmptyMatchesTomorrow: "Mañana hay {n} partidos — primer pitido a las {time}.",
  v3EmptyOffersTitle: "No hay ofertas en tu país",
  v3EmptyOffersLine: "Aquí no hay nada todavía; las predicciones siguen abiertas para todos.",
  v3EmptySnapshotTitle: "Aún sin snapshot",
  v3EmptySnapshotLine: "El modelo corre a las {time}; hasta entonces no damos cifras.",
  v3EmptyEditorTitle: "La selección del editor está vacía",
  v3EmptyEditorLine: "La franja se llena sola — las cuatro señales más fuertes ya están en marcha.",
  v3NotFoundTitle: "Balón fuera",
  v3NotFoundLine: "El balón salió del campo. Volvamos a la portada.",
  v3BackToPredictions: "Volver a las predicciones de hoy",
  v3PlayResponsibly: "Juega con responsabilidad",
  v3FreeBetsTitle: "Apuestas gratis y ofertas",
  v3NActiveOffers: "{n} ofertas activas",
  v3TermsAtOperator: "Los términos completos de cada oferta están en el operador.",
  v3OtherMarkets: "Otros mercados de este partido",
  v3LeagueRates: "Tasas de la liga · temporada hasta hoy",
  v3NMatches: "{n} partidos",
  v3FormLast5: "Forma · últimos 5",
  v3H2hLast: "Cara a cara · últimos {n}",
  v3From: "Desde",
  v3To: "Hasta",
  v3SmallSample: "muestra pequeña",
  v3NoSample: "sin muestra",
  v3FxVerdict: "Veredicto",
  v3FxEvidence: "Evidencia",
  v3FxHistory: "Historial",
  v3FxComparison: "Comparativa",
  v3FxPlay: "Jugar",
  v3SampleStrength: "Solidez de la muestra",
  v3PpVsLeague: "{pp} p.p. vs media de la liga",
  v3PlayThisMarket: "Jugar este mercado",
  v3TopPrice: "cuota más alta",
  v3LastFive: "Últimos 5",
  v3SnapshotLine: "Snapshot {time} · modelo {version} · {n} validaciones",
  v3DerivedLive: "Aún sin snapshot — derivado en directo de los mismos datos de entrada",
  v3SortedByDeviation: "Ordenado por desviación · barra = tasa · línea blanca = media de la liga",
  v3LeagueAvgIs: "media de la liga {pct}%",
  v3NMoreSignals: "{n} señales más",
  v3H2hTitle: "Historial cara a cara",
  v3LastNMeetings: "Últimos {n} enfrentamientos · {from}–{to}",
  v3NWinsPct: "{n} victorias · {pct}%",
  v3NDrawsPct: "{n} empates · {pct}%",
  v3CleanSheetFor: "{team} sin encajar",
  v3ModelView: "La visión del modelo",
  v3WhyMarket: "Por qué {market} y no el resultado",
  v3TplHomeGoals: "Los partidos de {team} en casa promedian {avg} goles.",
  v3TplAwayConceded: "{team} encaja {avg} por partido fuera de casa.",
  v3TplLeagueGoals: "La liga promedia {avg} goles por partido.",
  v3TplEarlyGoals: "Hubo gol en la primera parte en el {pct}% de los partidos de {team} en casa.",
  v3TplResultTight: "El mercado de resultado está más ajustado: {team} ganó el {pct}% de sus partidos en casa.",
  v3Overall: "Global",
  v3HomeShort: "Casa",
  v3AwayShort: "Fuera",
  v3PtsPerMatch: "Pts/partido",
  v3WinPct: "Victorias %",
  v3GoalsAvg: "Media de goles",
  v3ScoredAvg: "Marcados",
  v3ConcededAvg: "Encajados",
  v3CleanSheetPct: "Portería a cero %",
  v3FailedToScorePct: "Sin marcar %",
  v3LeadsRow: "Verde = el lado que va por delante en esa fila.",
  v3OperatorsMatchMarkets: "Operadores · mercados de este partido",
  v3TopPriceOutline: "Contorno verde = la cuota más alta del mercado.",
  v3NoObservation: "sin observación",
  v3MktOver35: "Más de 3,5",
  v3MktCleanSheet: "Portería a cero",
  v3MktFailedToScore: "Sin marcar",
  v3StrongestSignals: "Señales más fuertes",
  v3MktOver15: "Más de 1,5",
  v3MktOver25: "Más de 2,5",
  v3MktUnder25: "Menos de 2,5",
  v3MktFh: "1T más de 0,5",
  v3MktSh: "2T más de 0,5",
  v3MktBtts: "Ambos marcan",
  v3MktBttsNo: "No ambos marcan",
  v3MktHomeWin: "Gana el local",
  v3MktHomeUnbeaten: "Local invicto",
...
const de: PredictionStrings = mergePredictions({
  /* V3 reskin — session 1 (v3 keys). */
  v3NavPredictions: "Vorhersagen",
  v3NavBettingTips: "Wett-Tipps",
  v3NavBettingSites: "Wettanbieter",
  v3NavFreeBets: "Gratiswetten",
  v3NavSites: "Anbieter",
  v3NavRecord: "Bilanz",
  v3SignIn: "Anmelden",
  v3SearchPlaceholder: "Team, Liga oder Markt",
  v3PopularLeagues: "Beliebte Ligen",
  v3AllMatches: "Alle Spiele",
  v3Sponsored18: "Gesponsert · 18+",
  v3Best: "Top",
  v3Continue: "Weiter",
  v3CommissionLine: "Es gelten die Bedingungen. Wir erhalten über diese Links Provision; die Vorhersagen beeinflusst das nie.",
  v3VerifiedHitRate: "Verifizierte Trefferquote",
  v3Season: "Saison {season}",
  v3LockLine: "Jede Vorhersage wird beim Endstand festgeschrieben.",
  v3SeeRecord: "Zur Bilanz",
  v3HighPotentialToday: "Hohes Potenzial · heute",
  v3NPredictions: "{n} Vorhersagen",
  v3OfferOfTheDay: "Angebot des Tages",
  v3Live: "Live",
  v3ViewAll: "Alle ansehen",
  v3Today: "Heute",
  v3Tomorrow: "Morgen",
  v3Weekend: "Wochenende",
  v3AllMarkets: "Alle Märkte",
  v3SortByRate: "Nach Trefferquote",
  v3ColTime: "Zeit",
  v3ColMatch: "Spiel",
  v3ColLeague: "Liga",
  v3ColMarket: "Markt",
  ...
  v3ColSample: "Basis",
  v3ColForm: "Form",
  v3ColBestOdds: "Beste Quote",
  v3NMoreMatches: "{n} weitere Spiele",
  v3OddsAsOf: "Quoten, Stand {time}",
  v3SponsoredLinks: "Gesponserte Links · 18+",
  v3EditorPick: "Tipp der Redaktion",
  v3More: "mehr",
  v3EditorNote: "Anmerkung der Redaktion",
  v3EmptyMatchesTitle: "Heute keine Spiele",
  v3EmptyMatchesLine: "Der Platz bleibt heute leer.",
  v3EmptyMatchesTomorrow: "Morgen stehen {n} Spiele an — Anpfiff ab {time}.",
  v3EmptyOffersTitle: "Keine Angebote in deinem Land",
  v3EmptyOffersLine: "Hier gibt es noch nichts; die Vorhersagen bleiben für alle offen.",
  v3EmptySnapshotTitle: "Noch kein Snapshot",
  v3EmptySnapshotLine: "Das Modell läuft um {time}; bis dahin nennen wir keine Zahlen.",
  v3EmptyEditorTitle: "Die Redaktionsauswahl ist leer",
  v3EmptyEditorLine: "Das Band füllt sich selbst — die vier stärksten Signale sind bereits live.",
  v3NotFoundTitle: "Ball im Aus",
  v3NotFoundLine: "Der Ball ist im Aus gelandet. Zurück zur Startseite.",
  v3BackToPredictions: "Zurück zu den heutigen Vorhersagen",
  v3PlayResponsibly: "Spiel verantwortungsvoll",
  v3FreeBetsTitle: "Gratiswetten und Angebote",
  v3NActiveOffers: "{n} aktive Angebote",
  v3TermsAtOperator: "Die vollständigen Bedingungen jedes Angebots stehen beim Anbieter.",
  v3OtherMarkets: "Weitere Märkte dieses Spiels",
  v3LeagueRates: "Liga-Raten · Saison bisher",
  v3NMatches: "{n} Spiele",
  v3FormLast5: "Form · letzte 5",
  v3H2hLast: "Direktvergleich · letzte {n}",
  v3From: "Von",
  v3To: "Bis",
  v3SmallSample: "kleine Stichprobe",
  v3NoSample: "keine Stichprobe",
  v3FxVerdict: "Fazit",
  v3FxEvidence: "Belege",
  v3FxHistory: "Historie",
  v3FxComparison: "Vergleich",
  v3FxPlay: "Spielen",
  v3SampleStrength: "Stärke der Datenbasis",
  v3PpVsLeague: "{pp} PP gegenüber Ligaschnitt",
  v3PlayThisMarket: "Diesen Markt spielen",
  v3TopPrice: "Top-Quote",
  v3LastFive: "Letzte 5",
  v3SnapshotLine: "Snapshot {time} · Modell {version} · {n} Validierungen",
  v3DerivedLive: "Noch kein Snapshot — live aus denselben Eingaben abgeleitet",
  v3SortedByDeviation: "Nach Abweichung sortiert · Balken = Rate · weiße Linie = Ligaschnitt",
  v3LeagueAvgIs: "Ligaschnitt {pct}%",
  v3NMoreSignals: "{n} weitere Signale",
  v3H2hTitle: "Bilanz im Direktvergleich",
  v3LastNMeetings: "Letzte {n} Duelle · {from}–{to}",
  v3NWinsPct: "{n} Siege · {pct}%",
  v3NDrawsPct: "{n} Remis · {pct}%",
  v3CleanSheetFor: "{team} ohne Gegentor",
  v3ModelView: "Die Sicht des Modells",
  v3WhyMarket: "Warum {market} und nicht das Ergebnis",
  v3TplHomeGoals: "Die Heimspiele von {team} bringen im Schnitt {avg} Tore.",
  v3TplAwayConceded: "{team} kassiert auswärts {avg} pro Spiel.",
  v3TplLeagueGoals: "Die Liga liegt im Schnitt bei {avg} Toren pro Spiel.",
  v3TplEarlyGoals: "In {pct}% der Heimspiele von {team} fiel ein Tor vor der Pause.",
  v3TplResultTight: "Der Ergebnismarkt ist enger: {team} gewann {pct}% der Heimspiele.",
  v3Overall: "Gesamt",
  v3HomeShort: "Heim",
  v3AwayShort: "Auswärts",
  v3PtsPerMatch: "Pkt./Spiel",
  v3WinPct: "Siege %",
  v3GoalsAvg: "Ø Tore",
  v3ScoredAvg: "Erzielt",
  v3ConcededAvg: "Kassiert",
  v3CleanSheetPct: "Zu-null-Spiele %",
  v3FailedToScorePct: "Ohne Torerfolg %",
  v3LeadsRow: "Grün = die in dieser Zeile führende Seite.",
  v3OperatorsMatchMarkets: "Anbieter · Märkte dieses Spiels",
  v3TopPriceOutline: "Grüner Rahmen = Top-Quote des Marktes.",
  v3NoObservation: "keine Beobachtung",
  v3MktOver35: "Über 3,5",
  v3MktCleanSheet: "Zu null",
  v3MktFailedToScore: "Ohne Torerfolg",
  v3StrongestSignals: "Stärkste Signale",
  v3MktOver15: "Über 1,5",
  v3MktOver25: "Über 2,5",
  v3MktUnder25: "Unter 2,5",
  v3MktFh: "1. HZ über 0,5",
  v3MktSh: "2. HZ über 0,5",
  v3MktBtts: "Beide treffen",
  v3MktBttsNo: "Nicht beide treffen",
  v3MktHomeWin: "Heimsieg",
  v3MktHomeUnbeaten: "Heim unbesiegt",
  ...
  /* Acca interior strings — language sweep block 3 (app/apb/apx/apd/aps keys). */
  appTitle: "Ihr Acca",
  appCountLine: "{n} Auswahlen · nur Recherche-Schein",
  appCloseAria: "Acca-Panel schließen",
  appDismiss: "Ausblenden",
  appUndo: "Rückgängig",
  appClearAll: "Alles löschen",
  appCleared: "Acca geleert.",
  appOpenStudio: "Studio öffnen",
  appEmptySlip:
    "Fügen Sie Auswahlen von Spielseiten, den geordneten Märkten oder dem Spiel-Explorer hinzu. Nur Märkte mit unterstützter Abrechnung stehen bereit.",
  appOddsUnavailable: "Quoten nicht verfügbar",
  appProviderPotential: "Anbieter-Potenzial {pct}% (keine Stichprobe)",
  appMatchDetail: "Spieldetail",
  appRemove: "Entfernen",
  appRemoveAria: "{home} vs {away} entfernen",
  appCombinedOdds: "Kombinierte Quoten",
  appIncomplete: "unvollständig",
  appRiskClass: "Risikoklasse",
  appStakeUnits: "Einheiten (Basiseinsatz)",
  appPotentialReturn: "Möglicher Ertrag",
  appPotentialProfit: "Möglicher Gewinn",
  appUnitsNote:
    "Einheiten sind währungsneutrale Recherche-Werte — kein Wallet und keine platzierte Wette.",
  appNameLabel: "Diesem Acca einen Namen geben",
  appNamePlaceholder: "z. B. Samstags-Overs",
  appSaveNamed: "Benannten Acca speichern",
  appSavedLocally: "Lokal gespeichert.",
  appCopy: "Kopieren",
  appCopied: "Als Text kopiert.",
  appTelegramText: "Telegram-Text",
  appTelegramCopied: "Telegram-freundlicher Text kopiert.",
  appShareUrl: "Teilen-URL",
  appShareCopied: "URL kopiert (Noindex-Wiederherstellungslink).",
  appClipboardUnavailable: "Zwischenablage nicht verfügbar.",
  appSavedAccas: "Gespeicherte Accas",
  appDelete: "Löschen",
  appDeleteAria: "{name} löschen",
  apbConfigTitle: "Builder-Konfiguration",
  apbRiskMode: "Risikomodus",
  apbAllowedMarkets: "Erlaubte Märkte",
  apbTargetMin: "Zielquote min. (optional)",
  apbTargetMax: "Zielquote max. (optional)",
  apbExcludeTeams: "Teams ausschließen (kommagetrennt)",
  apbCompetitionFilter: "Wettbewerbsfilter (kommagetrennt, optional)",
  apbOnePerFixture: "Eine Auswahl pro Spiel",
  apbPrematchOnly: "Nur Vor-Spiel",
  apbGenerate: "Acca generieren",
  apbGenerating: "Wird generiert…",
  apbGeneratingLong: "Kombi-Vorschläge werden generiert…",
  apbIdleNote:
    "Filter konfigurieren, dann generieren. Kombinationen nutzen echte veröffentlichte Listen-Vorhersagen — niemals erfundene Spiele oder Quoten.",
  apbRanked: "Geordnete Kombinationen",
  apbNoCombo:
    "Keine gültige Kombination für diese Konfiguration. Lockern Sie Konfidenz, Märkte oder Beinanzahl — die Qualitätsschranken werden nicht automatisch gesenkt.",
  apbGenerationFailed: "Generierung fehlgeschlagen.",
  apbTimeout: "Anbieter-Anfrage abgelaufen. Bitte erneut versuchen.",
  apbNetworkFail: "Netzwerkfehler — Verbindung prüfen und erneut versuchen.",
  apbRecommended: "Empfohlen",
  apbSafer: "Sicherere Alternative",
  apbHigherRisk: "Risikoreichere Alternative",
  apbOddsUnavailable: "Quoten nicht verfügbar",
  apbAddAll: "Ganzen Acca ins Studio übernehmen",
  apbAddOne: "Zu den Kombiwetten hinzufügen",
  apbReplace: "Ersetzen",
  apbCancel: "Abbrechen",
  apbWhyLeg: "Warum dieses Bein",
  apbWarningsAria: "Warnungen",
  apbAccasUnavailable:
    "Kombiwetten sind in dieser Ansicht nicht verfügbar. Öffnen Sie zuerst die Kombiwetten.",
  apbOpenAccas: "Kombiwetten öffnen",
  apxLede:
    "Mehrfach-Kombinationen aus unseren qualifizierten Listen, veröffentlicht mit ihrer Evidenz.",
  apxLede2:
    "Jede ist eine deterministische Kombination von Auswahlen, die sich bereits für unsere veröffentlichten Listen qualifiziert hatten — nie eine Handauswahl und nie nachträglich neu bewertet. Ihre Seite nennt die enthaltenen Auswahlen, was zu jeder festgehalten wurde, wann sie generiert und veröffentlicht wurde und ob ihre Spiele begonnen haben.",
  apxStillAhead: "Noch offen",
  apxStillAheadNote: "Neueste zuerst. Mindestens ein Spiel von jedem hat noch nicht begonnen.",
  apxSettledNote:
    "Alle Spiele dieser Kombis haben begonnen. Sie bleiben veröffentlicht als Beleg dessen, was vorab gesagt wurde. Ergebnisse werden auf einer Acca-Seite nicht erfasst — abgerechnete Einzelvorhersagen leben im Archiv.",
  apxNothingFilter: "Nichts passt zu diesem Filter",
  apxNothingYet: "Noch nichts veröffentlicht",
  apxNothingFilterDesc:
    "Kein veröffentlichter Acca passt zu den gewählten Filtern. Löschen Sie sie, um alles für diese Sprache Veröffentlichte zu sehen.",
  apxNothingYetDesc:
    "Für diese Sprache wurden keine Accas veröffentlicht. Statt Platzhalter zu füllen bleibt die Seite leer, bis es etwas Echtes zu zeigen gibt.",
  apxOlderNote:
    "Diese Liste prüft die {n} zuletzt veröffentlichten Accas dieser Sprache. Ältere existieren im Speicher und werden hier nicht gezeigt.",
  apxFullBreakdown: "die vollständige Aufschlüsselung",
  apxFilterProfile: "Profil",
  apxFilterCompetition: "Wettbewerb",
  apxClosed: "Geschlossen",
  apxTodaysListsNote: "— die Listen, aus denen sie gebaut werden.",
  apxBuilderNote: "— bauen Sie Ihren eigenen aus derselben Evidenz.",
  apxArchiveNote: "— abgerechnete Ergebnisse, Siege wie Niederlagen.",
  apxHowBuilt: "Wie sie gebaut werden",
  apxFirstKickoff: "Erster Anstoß",
  apxLimitationsNoted: "{n} Einschränkungen vermerkt — siehe die vollständige Aufschlüsselung.",
  apxFilterState: "Status",
  apxPagesAria: "Seiten veröffentlichter Accas",
  apdAtAGlance: "Auf einen Blick",
  apdSelections: "Auswahlen",
  apdBuilderProfile: "Builder-Profil",
  apdGenerated: "Generiert",
  apdPublished: "Veröffentlicht",
  apdState: "Status",
  apdSelectionsTitle: "Die {n} Auswahlen",
  apdTableCaption: "Auswahlen dieses Accas mit den bei Veröffentlichung erfassten Quoten",
  apdColFixture: "Spiel",
  apdColKickoff: "Anstoß (UTC)",
  apdColEvidence: "Evidenz",
  apdColPotential: "Anbieter-Potenzial",
  apdColOddsAtPub: "Quoten bei Veröffentlichung",
  apdCombinedNote:
    "Kombinierte Quoten sind das Produkt der obigen Einzelpreise, exakt berechnet und einmal gerundet. Sie sind weder eine Wahrscheinlichkeit noch eine Ertragsschätzung.",
  apdWhyTitle: "Warum diese Auswahlen",
  apdWhyNote:
    "Jede Auswahl unten hatte sich bereits für unsere veröffentlichten Listen qualifiziert, bevor der Builder sie kombinierte. Klappen Sie eine auf, um genau zu sehen, was damals festgehalten wurde. Eine Auswahl ohne Aufzeichnung sagt es — ein leeres Panel ist eine Lücke im Register, kein stilles Gütesiegel.",
  apdQualification: "Qualifikation",
  apdQualifiedLine:
    "Bestand die Konfidenz-, Frische-, Konflikt- und Evidenzschranken des Builders, als die Kombination generiert wurde.",
  apdPriceRecorded: "Erfasster Preis",
  apdProvenance: "Herkunft",
  apdBuiltOn: "Worauf sie beruht",
  apdNoAggregateNotes: "Für diese Kombination wurden keine aggregierten Evidenznotizen erfasst.",
  apdWithPotential: "Auswahlen mit Anbieter-Potenzial",
  apdAvgPotential: "Durchschnittliches Anbieter-Potenzial",
  apdCompleteness: "Evidenz-Vollständigkeit",
  apdProvenanceTitle: "Herkunft und Datenfrische",
  apdWithReasons: "Auswahlen mit schriftlichen Gründen",
  apdOddsCaptured: "Quoten erfasst",
  apdPriceAge: "Preisalter",
  apdPublicationFormat: "Publikationsformat",
  apdOfCount: "{a} von {b}",
  apsLinkCopied: "Link in die Zwischenablage kopiert.",
  apsClipboardManual:
    "Die Zwischenablage ist hier nicht verfügbar. Der Link ist markiert — kopieren Sie ihn manuell.",
  apsShareSheetOpened: "Teilen-Dialog geöffnet.",

});

const it: PredictionStrings = mergePredictions({
  /* V3 reskin — session 1 (v3 keys). */
  v3NavPredictions: "Pronostici",
  v3NavBettingTips: "Consigli scommesse",
  v3NavBettingSites: "Siti di scommesse",
  v3NavFreeBets: "Scommesse gratis",
  v3NavSites: "Siti",
  v3NavRecord: "Registro",
  v3SignIn: "Accedi",
  v3SearchPlaceholder: "Squadra, lega o mercato",
  v3PopularLeagues: "Leghe popolari",
  v3AllMatches: "Tutte le partite",
  v3Sponsored18: "Sponsorizzato · 18+",
  v3Best: "Top",
  v3Continue: "Continua",
  v3CommissionLine: "Si applicano i termini. Riceviamo una commissione da questi link; non influisce mai sui pronostici.",
  v3VerifiedHitRate: "Riuscita verificata",
  v3Season: "Stagione {season}",
  v3LockLine: "Ogni pronostico si blocca al risultato finale.",
  v3SeeRecord: "Vedi il registro",
  v3HighPotentialToday: "Alto potenziale · oggi",
  v3NPredictions: "{n} pronostici",
  v3OfferOfTheDay: "Offerta del giorno",
  v3Live: "Live",
  v3ViewAll: "Vedi tutto",
  v3Today: "Oggi",
  v3Tomorrow: "Domani",
  v3Weekend: "Weekend",
  v3AllMarkets: "Tutti i mercati",
  v3SortByRate: "Per riuscita",
  v3ColTime: "Ora",
  v3ColMatch: "Partita",
  v3ColLeague: "Lega",
  v3ColMarket: "Mercato",
  v3ColRate: "Riuscita",
  v3ColSample: "Campione",
  v3ColForm: "Forma",
  v3ColBestOdds: "Quota migliore",
  v3NMoreMatches: "Altre {n} partite",
  v3OddsAsOf: "Quote alle {time}",
  v3SponsoredLinks: "Link sponsorizzati · 18+",
  v3EditorPick: "Scelta della redazione",
  v3More: "altro",
  v3EditorNote: "Nota della redazione",
  v3EmptyMatchesTitle: "Oggi niente partite",
  v3EmptyMatchesLine: "Il campo oggi resta vuoto.",
  v3EmptyMatchesTomorrow: "Domani ci sono {n} partite — primo fischio alle {time}.",
  v3EmptyOffersTitle: "Nessuna offerta nel tuo paese",
  v3EmptyOffersLine: "Qui non c'è ancora nulla; i pronostici restano aperti a tutti.",
  v3EmptySnapshotTitle: "Ancora nessuno snapshot",
  v3EmptySnapshotLine: "Il modello gira alle {time}; fino ad allora niente numeri.",
  v3EmptyEditorTitle: "La scelta della redazione è vuota",
  v3EmptyEditorLine: "La fascia si riempie da sola — i quattro segnali più forti sono già in onda.",
  v3NotFoundTitle: "Palla fuori",
  v3NotFoundLine: "La palla è finita fuori campo. Torniamo alla home.",
  v3BackToPredictions: "Torna ai pronostici di oggi",
  v3PlayResponsibly: "Gioca responsabilmente",
  v3FreeBetsTitle: "Scommesse gratis e offerte",
  v3NActiveOffers: "{n} offerte attive",
  v3TermsAtOperator: "I termini completi di ogni offerta sono presso l'operatore.",
  v3OtherMarkets: "Altri mercati di questa partita",
  v3LeagueRates: "Tassi del campionato · stagione finora",
  v3NMatches: "{n} partite",
  v3FormLast5: "Forma · ultime 5",
  v3H2hLast: "Scontri diretti · ultimi {n}",
  v3From: "Da",
  v3To: "A",
  v3SmallSample: "campione piccolo",
  v3NoSample: "nessun campione",
  v3FxVerdict: "Verdetto",
  v3FxEvidence: "Evidenze",
  v3FxHistory: "Storico",
  v3FxComparison: "Confronto",
  v3FxPlay: "Gioca",
  v3SampleStrength: "Solidità del campione",
  v3PpVsLeague: "{pp} p.p. vs media del campionato",
  v3PlayThisMarket: "Gioca questo mercato",
  v3TopPrice: "quota massima",
  v3LastFive: "Ultime 5",
  v3SnapshotLine: "Snapshot {time} · modello {version} · {n} validazioni",
  v3DerivedLive: "Ancora nessuno snapshot — derivato in tempo reale dagli stessi input",
  v3SortedByDeviation: "Ordinato per scostamento · barra = tasso · linea bianca = media del campionato",
  v3LeagueAvgIs: "media campionato {pct}%",
  v3NMoreSignals: "altri {n} segnali",
  v3H2hTitle: "Bilancio degli scontri diretti",
  v3LastNMeetings: "Ultimi {n} incontri · {from}–{to}",
  v3NWinsPct: "{n} vittorie · {pct}%",
  v3NDrawsPct: "{n} pareggi · {pct}%",
  v3CleanSheetFor: "{team} senza subire gol",
  v3ModelView: "La lettura del modello",
  v3WhyMarket: "Perché {market} e non il risultato",
  v3TplHomeGoals: "Le partite casalinghe di {team} hanno una media di {avg} gol.",
  v3TplAwayConceded: "{team} subisce {avg} a partita in trasferta.",
  v3TplLeagueGoals: "Il campionato ha una media di {avg} gol a partita.",
  v3TplEarlyGoals: "Un gol nel primo tempo è arrivato nel {pct}% delle partite in casa di {team}.",
  v3TplResultTight: "Il mercato del risultato è più stretto: {team} ha vinto il {pct}% delle partite in casa.",
  v3Overall: "Totale",
  v3HomeShort: "Casa",
  v3AwayShort: "Trasferta",
  v3PtsPerMatch: "Pt/partita",
  v3WinPct: "Vittorie %",
  v3GoalsAvg: "Media gol",
  v3ScoredAvg: "Fatti",
  v3ConcededAvg: "Subiti",
  v3CleanSheetPct: "Porta inviolata %",
  v3FailedToScorePct: "Senza segnare %",
  v3LeadsRow: "Verde = il lato in vantaggio in quella riga.",
  v3OperatorsMatchMarkets: "Operatori · mercati di questa partita",
  v3TopPriceOutline: "Bordo verde = la quota massima del mercato.",
  v3NoObservation: "nessuna osservazione",
  v3MktOver35: "Over 3,5",
  v3MktCleanSheet: "Porta inviolata",
  v3MktFailedToScore: "Senza segnare",
  v3StrongestSignals: "Segnali più forti",
  ...
  v3MktBtts: "Gol",
  v3MktBttsNo: "No gol",
  v3MktHomeWin: "Vittoria casa",
  v3MktHomeUnbeaten: "Casa imbattuta",
  ...
  /* Acca interior strings — language sweep block 3 (app/apb/apx/apd/aps keys). */
  appTitle: "La tua Acca",
  appCountLine: "{n} selezioni · solo schedina di ricerca",
  appCloseAria: "Chiudi il pannello Acca",
  appDismiss: "Ignora",
  appUndo: "Annulla",
  appClearAll: "Cancella tutto",
  appCleared: "Acca svuotata.",
  appOpenStudio: "Apri lo studio",
  appEmptySlip:
    "Aggiungi selezioni dalle pagine partita, dai mercati ordinati o dall'esploratore delle partite. Sono disponibili solo mercati con regolamento supportato.",
  appOddsUnavailable: "quote non disponibili",
  appProviderPotential: "potenziale del fornitore {pct}% (senza campione)",
  appMatchDetail: "Dettaglio partita",
  appRemove: "Rimuovi",
  appRemoveAria: "Rimuovi {home} vs {away}",
  appCombinedOdds: "Quote combinate",
  appIncomplete: "incompleto",
  appRiskClass: "Classe di rischio",
  appStakeUnits: "Unità (puntata base)",
  appPotentialReturn: "Ritorno potenziale",
  appPotentialProfit: "Profitto potenziale",
  appUnitsNote:
    "Le unità sono valori di ricerca neutri — non un portafoglio né una scommessa piazzata.",
  appNameLabel: "Dai un nome a questa Acca",
  appNamePlaceholder: "es. Overs del sabato",
  appSaveNamed: "Salva Acca con nome",
  appSavedLocally: "Salvata in locale.",
  appCopy: "Copia",
  appCopied: "Copiata come testo.",
  appTelegramText: "Testo Telegram",
  appTelegramCopied: "Testo per Telegram copiato.",
  appShareUrl: "URL di condivisione",
  appShareCopied: "URL copiato (link di ripristino noindex).",
  appClipboardUnavailable: "Appunti non disponibili.",
  appSavedAccas: "Acca salvate",
  appDelete: "Elimina",
  appDeleteAria: "Elimina {name}",
  apbConfigTitle: "Configurazione del costruttore",
  apbRiskMode: "Modalità di rischio",
  apbAllowedMarkets: "Mercati consentiti",
  apbTargetMin: "Quota obiettivo min. (facoltativa)",
  apbTargetMax: "Quota obiettivo max. (facoltativa)",
  apbExcludeTeams: "Escludi squadre (separate da virgole)",
  apbCompetitionFilter: "Filtro competizione (separato da virgole, facoltativo)",
  apbOnePerFixture: "Una selezione per partita",
  apbPrematchOnly: "Solo pre-partita",
  apbGenerate: "Genera Acca",
  apbGenerating: "Generazione…",
  apbGeneratingLong: "Generazione di suggerimenti per multiple…",
  apbIdleNote:
    "Configura i filtri e genera. Le combinazioni usano previsioni pubblicate reali — mai partite o quote inventate.",
  apbRanked: "Combinazioni ordinate",
  apbNoCombo:
    "Nessuna combinazione valida con questa configurazione. Allenta confidenza, mercati o numero di selezioni — le soglie di qualità non si abbassano da sole.",
  apbGenerationFailed: "Generazione non riuscita.",
  apbTimeout: "La richiesta al fornitore è scaduta. Riprova.",
  apbNetworkFail: "Errore di rete — controlla la connessione e riprova.",
  apbRecommended: "Consigliata",
  apbSafer: "Alternativa più sicura",
  apbHigherRisk: "Alternativa più rischiosa",
  apbOddsUnavailable: "Quote non disponibili",
  apbAddAll: "Aggiungi l'intera Acca allo Studio",
  apbAddOne: "Aggiungi alle multiple",
  apbReplace: "Sostituisci",
  apbCancel: "Annulla",
  apbWhyLeg: "Perché questa selezione",
  apbWarningsAria: "Avvisi",
  apbAccasUnavailable: "Le multiple non sono disponibili in questa vista. Apri prima le multiple.",
  apbOpenAccas: "Apri le multiple",
  apxLede:
    "Combinazioni multi-selezione assemblate dalle nostre liste qualificate, pubblicate con la loro evidenza.",
  apxLede2:
    "Ognuna è una combinazione deterministica di selezioni già qualificate per le nostre liste pubblicate — mai una scelta manuale, e mai ripunteggiata dopo. La sua pagina indica quali selezioni contiene, cosa è stato registrato a sostegno di ciascuna, quando è stata generata e pubblicata, e se le sue partite sono iniziate.",
  apxStillAhead: "Ancora da giocare",
  apxStillAheadNote: "Le più recenti prima. Almeno una partita di ciascuna non è iniziata.",
  apxSettledNote:
    "Tutte le partite di queste sono iniziate. Restano pubblicate come traccia di quanto detto in anticipo. Gli esiti non si annotano sulla pagina di una Acca — le previsioni singole regolate vivono nell'archivio.",
  apxNothingFilter: "Niente corrisponde a quel filtro",
  apxNothingYet: "Ancora niente di pubblicato",
  apxNothingFilterDesc:
    "Nessuna Acca pubblicata corrisponde ai filtri scelti. Azzerali per vedere tutto ciò che è pubblicato in questa lingua.",
  apxNothingYetDesc:
    "Non sono state pubblicate Acca in questa lingua. Invece di riempire con contenuto segnaposto, la pagina resta vuota finché non c'è qualcosa di reale da mostrare.",
  apxOlderNote:
    "Questo elenco esamina le {n} Acca pubblicate più di recente per questa lingua. Le più vecchie esistono in archivio e non sono mostrate qui.",
  apxFullBreakdown: "l'analisi completa",
  apxFilterProfile: "Profilo",
  apxFilterCompetition: "Competizione",
  apxClosed: "Chiuse",
  apxTodaysListsNote: "— le liste da cui sono costruite.",
  apxBuilderNote: "— assembla la tua dalla stessa evidenza.",
  apxArchiveNote: "— esiti regolati, vittorie e sconfitte allo stesso modo.",
  apxHowBuilt: "Come sono costruite",
  apxFirstKickoff: "Primo calcio d'inizio",
  apxLimitationsNoted: "{n} limitazioni annotate — vedi l'analisi completa.",
  apxFilterState: "Stato",
  apxPagesAria: "Pagine delle Acca pubblicate",
  apdAtAGlance: "A colpo d'occhio",
  apdSelections: "Selezioni",
  apdBuilderProfile: "Profilo del costruttore",
  apdGenerated: "Generata",
  apdPublished: "Pubblicata",
  apdState: "Stato",
  apdSelectionsTitle: "Le {n} selezioni",
  apdTableCaption: "Selezioni di questa Acca, con le quote rilevate alla pubblicazione",
  apdColFixture: "Partita",
  apdColKickoff: "Calcio d'inizio (UTC)",
  apdColEvidence: "Evidenza",
  apdColPotential: "Potenziale del fornitore",
  apdColOddsAtPub: "Quote alla pubblicazione",
  apdCombinedNote:
    "Le quote combinate sono il prodotto dei prezzi individuali qui sopra, calcolato esattamente e arrotondato una sola volta. Non sono una probabilità né una stima di ritorno.",
  apdWhyTitle: "Perché queste selezioni",
  apdWhyNote:
    "Ogni selezione qui sotto si era già qualificata per le nostre liste pubblicate prima che il costruttore la combinasse. Espandine una per vedere esattamente cosa fu registrato allora. Una selezione senza nulla di registrato lo dice — un pannello vuoto è una lacuna nel registro, non un tacito avallo.",
  apdQualification: "Qualificazione",
  apdQualifiedLine:
    "Ha superato le soglie di confidenza, freschezza, conflitto ed evidenza del costruttore quando la combinazione è stata generata.",
  apdPriceRecorded: "Prezzo registrato",
  apdProvenance: "Provenienza",
  apdBuiltOn: "Su cosa è costruita",
  apdNoAggregateNotes: "Nessuna nota di evidenza aggregata è stata registrata per questa combinazione.",
  apdWithPotential: "Selezioni con potenziale del fornitore",
  apdAvgPotential: "Potenziale medio del fornitore",
  apdCompleteness: "Completezza dell'evidenza",
  apdProvenanceTitle: "Provenienza e freschezza dei dati",
  apdWithReasons: "Selezioni con motivazioni scritte",
  apdOddsCaptured: "Quote rilevate",
  apdPriceAge: "Età del prezzo",
  apdPublicationFormat: "Formato di pubblicazione",
  apdOfCount: "{a} di {b}",
  apsLinkCopied: "Link copiato negli appunti.",
  apsClipboardManual:
    "Gli appunti non sono disponibili qui. Il link è selezionato — copialo manualmente.",
  apsShareSheetOpened: "Riquadro di condivisione aperto.",

});

const fr: PredictionStrings = mergePredictions({
  /* V3 reskin — session 1 (v3 keys). */
  v3NavPredictions: "Pronostics",
  v3NavBettingTips: "Conseils de paris",
  v3NavBettingSites: "Sites de paris",
  v3NavFreeBets: "Paris gratuits",
  v3NavSites: "Sites",
  v3NavRecord: "Historique",
  v3SignIn: "Connexion",
  v3SearchPlaceholder: "Équipe, ligue ou marché",
  v3PopularLeagues: "Ligues populaires",
  v3AllMatches: "Tous les matchs",
  v3Sponsored18: "Sponsorisé · 18+",
  v3Best: "Top",
  v3Continue: "Continuer",
  v3CommissionLine: "Conditions applicables. Ces liens nous rapportent une commission ; elle n'influence jamais les pronostics.",
  v3VerifiedHitRate: "Réussite vérifiée",
  v3Season: "Saison {season}",
  v3LockLine: "Chaque pronostic est figé au score final.",
  v3SeeRecord: "Voir l'historique",
  v3HighPotentialToday: "Fort potentiel · aujourd'hui",
  v3NPredictions: "{n} pronostics",
  v3OfferOfTheDay: "Offre du jour",
  v3Live: "En direct",
  v3ViewAll: "Tout voir",
  v3Today: "Aujourd'hui",
  v3Tomorrow: "Demain",
  v3Weekend: "Week-end",
  v3AllMarkets: "Tous les marchés",
  v3SortByRate: "Par réussite",
  v3ColTime: "Heure",
  v3ColMatch: "Match",
  v3ColLeague: "Ligue",
  v3ColMarket: "Marché",
  v3ColRate: "Réussite",
  v3ColSample: "Échantillon",
  v3ColForm: "Forme",
  v3ColBestOdds: "Meilleure cote",
  v3NMoreMatches: "{n} matchs de plus",
  v3OddsAsOf: "Cotes à {time}",
  v3SponsoredLinks: "Liens sponsorisés · 18+",
  v3EditorPick: "Choix de la rédaction",
  v3More: "la suite",
  v3EditorNote: "Note de la rédaction",
  v3EmptyMatchesTitle: "Pas de match aujourd'hui",
  v3EmptyMatchesLine: "Le terrain reste vide aujourd'hui.",
  v3EmptyMatchesTomorrow: "Demain, {n} matchs — premier coup d'envoi à {time}.",
  v3EmptyOffersTitle: "Aucune offre dans votre pays",
  v3EmptyOffersLine: "Rien ici pour l'instant ; les pronostics restent ouverts à tous.",
  v3EmptySnapshotTitle: "Pas encore de snapshot",
  v3EmptySnapshotLine: "Le modèle tourne à {time} ; d'ici là, pas de chiffres.",
  v3EmptyEditorTitle: "La sélection de la rédaction est vide",
  v3EmptyEditorLine: "Le bandeau se remplit seul — les quatre signaux les plus forts sont déjà en ligne.",
  v3NotFoundTitle: "Ballon sorti",
  v3NotFoundLine: "Le ballon est sorti du terrain. Retour à l'accueil.",
  v3BackToPredictions: "Retour aux pronostics du jour",
  v3PlayResponsibly: "Jouez de façon responsable",
  v3FreeBetsTitle: "Paris gratuits et offres",
  v3NActiveOffers: "{n} offres actives",
  v3TermsAtOperator: "Les conditions complètes de chaque offre sont chez l'opérateur.",
  v3OtherMarkets: "Autres marchés de ce match",
  v3LeagueRates: "Taux de la ligue · saison en cours",
  v3NMatches: "{n} matchs",
  v3FormLast5: "Forme · 5 derniers",
  v3H2hLast: "Face-à-face · {n} derniers",
  v3From: "Du",
  v3To: "Au",
  v3SmallSample: "petit échantillon",
  v3NoSample: "pas d'échantillon",
  v3FxVerdict: "Verdict",
  v3FxEvidence: "Indices",
  v3FxHistory: "Historique",
  v3FxComparison: "Comparaison",
  v3FxPlay: "Jouer",
  v3SampleStrength: "Solidité de l'échantillon",
  v3PpVsLeague: "{pp} pts vs moyenne de la ligue",
  v3PlayThisMarket: "Jouer ce marché",
  v3TopPrice: "cote la plus haute",
  v3LastFive: "5 derniers",
  v3SnapshotLine: "Snapshot {time} · modèle {version} · {n} validations",
  v3DerivedLive: "Pas encore de snapshot — dérivé en direct des mêmes données d'entrée",
  v3SortedByDeviation: "Trié par écart · barre = taux · ligne blanche = moyenne de la ligue",
  v3LeagueAvgIs: "moyenne ligue {pct}%",
  v3NMoreSignals: "{n} autres signaux",
  v3H2hTitle: "Bilan des face-à-face",
  v3LastNMeetings: "{n} dernières confrontations · {from}–{to}",
  v3NWinsPct: "{n} victoires · {pct}%",
  v3NDrawsPct: "{n} nuls · {pct}%",
  v3CleanSheetFor: "{team} sans but encaissé",
  v3ModelView: "La lecture du modèle",
  v3WhyMarket: "Pourquoi {market} et pas le résultat",
  v3TplHomeGoals: "Les matchs de {team} à domicile affichent une moyenne de {avg} buts.",
  v3TplAwayConceded: "{team} encaisse {avg} par match à l'extérieur.",
  v3TplLeagueGoals: "La ligue tourne à {avg} buts par match en moyenne.",
  v3TplEarlyGoals: "Un but en première mi-temps est tombé dans {pct}% des matchs de {team} à domicile.",
  v3TplResultTight: "Le marché du résultat est plus serré : {team} a gagné {pct}% de ses matchs à domicile.",
  v3Overall: "Global",
  v3HomeShort: "Dom.",
  v3AwayShort: "Ext.",
  ...
  v3GoalsAvg: "Moy. buts",
  v3ScoredAvg: "Marqués",
  v3ConcededAvg: "Encaissés",
  v3CleanSheetPct: "Sans but encaissé %",
  v3FailedToScorePct: "Sans marquer %",
  v3LeadsRow: "Vert = le côté en tête sur cette ligne.",
  v3OperatorsMatchMarkets: "Opérateurs · marchés de ce match",
  v3TopPriceOutline: "Contour vert = la cote la plus haute du marché.",
  v3NoObservation: "aucune observation",
  v3MktOver35: "Plus de 3,5",
  v3MktCleanSheet: "Sans but encaissé",
  v3MktFailedToScore: "Sans marquer",
  v3StrongestSignals: "Signaux les plus forts",
  v3MktOver15: "Plus de 1,5",
  v3MktOver25: "Plus de 2,5",
  v3MktUnder25: "Moins de 2,5",
  v3MktFh: "1re MT plus de 0,5",
  v3MktSh: "2e MT plus de 0,5",
  v3MktBtts: "Les deux marquent",
  v3MktBttsNo: "Pas les deux",
  v3MktHomeWin: "Victoire à domicile",
  v3MktHomeUnbeaten: "Domicile invaincu",
  ...
  /* Acca interior strings — language sweep block 3 (app/apb/apx/apd/aps keys). */
  appTitle: "Votre Acca",
  appCountLine: "{n} sélections · coupon de recherche uniquement",
  appCloseAria: "Fermer le panneau Acca",
  appDismiss: "Ignorer",
  appUndo: "Annuler l'action",
  appClearAll: "Tout effacer",
  appCleared: "Acca effacé.",
  appOpenStudio: "Ouvrir le studio",
  appEmptySlip:
    "Ajoutez des sélections depuis les pages de match, les marchés classés ou l'explorateur de matchs. Seuls les marchés à règlement pris en charge sont proposés.",
  appOddsUnavailable: "cotes indisponibles",
  appProviderPotential: "potentiel du fournisseur {pct}% (sans échantillon)",
  appMatchDetail: "Détail du match",
  appRemove: "Retirer",
  appRemoveAria: "Retirer {home} vs {away}",
  appCombinedOdds: "Cotes combinées",
  appIncomplete: "incomplet",
  appRiskClass: "Classe de risque",
  appStakeUnits: "Unités (mise de base)",
  appPotentialReturn: "Retour potentiel",
  appPotentialProfit: "Profit potentiel",
  appUnitsNote:
    "Les unités sont des valeurs de recherche neutres — ni un portefeuille, ni un pari placé.",
  appNameLabel: "Nommez cet Acca",
  appNamePlaceholder: "p. ex. Overs du samedi",
  appSaveNamed: "Enregistrer l'Acca nommé",
  appSavedLocally: "Enregistré localement.",
  appCopy: "Copier",
  appCopied: "Copié en texte.",
  appTelegramText: "Texte Telegram",
  appTelegramCopied: "Texte pour Telegram copié.",
  appShareUrl: "URL de partage",
  appShareCopied: "URL copiée (lien de restauration noindex).",
  appClipboardUnavailable: "Presse-papiers indisponible.",
  appSavedAccas: "Accas enregistrés",
  appDelete: "Supprimer",
  appDeleteAria: "Supprimer {name}",
  apbConfigTitle: "Configuration du constructeur",
  apbRiskMode: "Mode de risque",
  apbAllowedMarkets: "Marchés autorisés",
  apbTargetMin: "Cote cible min. (facultatif)",
  apbTargetMax: "Cote cible max. (facultatif)",
  apbExcludeTeams: "Exclure des équipes (séparées par des virgules)",
  apbCompetitionFilter: "Filtre de compétition (séparé par des virgules, facultatif)",
  apbOnePerFixture: "Une sélection par match",
  apbPrematchOnly: "Avant-match uniquement",
  apbGenerate: "Générer l'Acca",
  apbGenerating: "Génération…",
  apbGeneratingLong: "Génération de suggestions de combinés…",
  apbIdleNote:
    "Configurez les filtres puis générez. Les combinaisons utilisent de vraies prédictions publiées — jamais de matchs ni de cotes inventés.",
  apbRanked: "Combinaisons classées",
  apbNoCombo:
    "Aucune combinaison valide avec cette configuration. Assouplissez la confiance, les marchés ou le nombre de sélections — les garde-fous de qualité ne baissent pas automatiquement.",
  apbGenerationFailed: "La génération a échoué.",
  apbTimeout: "La requête au fournisseur a expiré. Réessayez.",
  apbNetworkFail: "Panne réseau — vérifiez votre connexion et réessayez.",
  apbRecommended: "Recommandé",
  apbSafer: "Alternative plus sûre",
  apbHigherRisk: "Alternative plus risquée",
  apbOddsUnavailable: "Cotes indisponibles",
  apbAddAll: "Ajouter tout l'Acca au Studio",
  apbAddOne: "Ajouter aux combinés",
  apbReplace: "Remplacer",
  apbCancel: "Annuler",
  apbWhyLeg: "Pourquoi cette sélection",
  apbWarningsAria: "Avertissements",
  apbAccasUnavailable:
    "Les combinés ne sont pas disponibles dans cette vue. Ouvrez d'abord les combinés.",
  apbOpenAccas: "Ouvrir les combinés",
  apxLede:
    "Des combinaisons multi-sélections assemblées depuis nos listes qualifiées, publiées avec leurs preuves.",
  apxLede2:
    "Chacune est une combinaison déterministe de sélections déjà qualifiées pour nos listes publiées — jamais un choix manuel, et jamais re-notée après coup. Sa page indique les sélections qu'elle contient, ce qui a été consigné à l'appui de chacune, quand elle a été générée et publiée, et si ses matchs ont commencé.",
  apxStillAhead: "Encore à venir",
  apxStillAheadNote: "Les plus récents d'abord. Au moins un match de chacun n'a pas commencé.",
  apxSettledNote:
    "Tous les matchs de ceux-ci ont commencé. Ils restent publiés comme trace de ce qui a été dit à l'avance. Les résultats ne sont pas consignés sur la page d'un Acca — les prédictions individuelles réglées vivent dans l'archive.",
  apxNothingFilter: "Rien ne correspond à ce filtre",
  apxNothingYet: "Rien de publié pour l'instant",
  apxNothingFilterDesc:
    "Aucun Acca publié ne correspond aux filtres choisis. Effacez-les pour voir tout ce qui est publié dans cette langue.",
  apxNothingYetDesc:
    "Aucun Acca n'a été publié dans cette langue. Plutôt que de remplir la page de contenu factice, elle reste vide jusqu'à ce qu'il y ait quelque chose de réel à montrer.",
  apxOlderNote:
    "Cette liste examine les {n} Accas publiés les plus récents pour cette langue. Les plus anciens existent en stockage et ne sont pas affichés ici.",
  apxFullBreakdown: "le détail complet",
  apxFilterProfile: "Profil",
  apxFilterCompetition: "Compétition",
  apxClosed: "Clos",
  apxTodaysListsNote: "— les listes dont ils sont issus.",
  apxBuilderNote: "— assemblez le vôtre à partir des mêmes preuves.",
  apxArchiveNote: "— résultats réglés, victoires et défaites confondues.",
  apxHowBuilt: "Comment ils sont construits",
  apxFirstKickoff: "Premier coup d'envoi",
  apxLimitationsNoted: "{n} limites notées — voir le détail complet.",
  apxFilterState: "État",
  apxPagesAria: "Pages d'Accas publiés",
  apdAtAGlance: "En un coup d'œil",
  apdSelections: "Sélections",
  apdBuilderProfile: "Profil du constructeur",
  apdGenerated: "Généré",
  apdPublished: "Publié",
  apdState: "État",
  apdSelectionsTitle: "Les {n} sélections",
  apdTableCaption: "Sélections de cet Acca, avec les cotes relevées à la publication",
  apdColFixture: "Match",
  apdColKickoff: "Coup d'envoi (UTC)",
  apdColEvidence: "Preuves",
  apdColPotential: "Potentiel du fournisseur",
  apdColOddsAtPub: "Cotes à la publication",
  apdCombinedNote:
    "Les cotes combinées sont le produit des prix individuels ci-dessus, calculé exactement et arrondi une seule fois. Ce n'est ni une probabilité ni une estimation de retour.",
  apdWhyTitle: "Pourquoi ces sélections",
  apdWhyNote:
    "Chaque sélection ci-dessous s'était déjà qualifiée pour nos listes publiées avant que le constructeur ne la combine. Dépliez-en une pour voir exactement ce qui a été consigné à l'époque. Une sélection sans rien de consigné le dit — un panneau vide est un manque dans le registre, pas un aval silencieux.",
  apdQualification: "Qualification",
  apdQualifiedLine:
    "A passé les garde-fous de confiance, fraîcheur, conflit et preuves du constructeur au moment de la génération.",
  apdPriceRecorded: "Prix relevé",
  apdProvenance: "Provenance",
  apdBuiltOn: "Sur quoi il repose",
  apdNoAggregateNotes: "Aucune note de preuve agrégée n'a été consignée pour cette combinaison.",
  apdWithPotential: "Sélections avec potentiel du fournisseur",
  apdAvgPotential: "Potentiel moyen du fournisseur",
  apdCompleteness: "Complétude des preuves",
  apdProvenanceTitle: "Provenance et fraîcheur des données",
  apdWithReasons: "Sélections avec raisons écrites",
  apdOddsCaptured: "Cotes relevées",
  apdPriceAge: "Âge du prix",
  apdPublicationFormat: "Format de publication",
  apdOfCount: "{a} sur {b}",
  apsLinkCopied: "Lien copié dans le presse-papiers.",
  apsClipboardManual:
    "Le presse-papiers n'est pas disponible ici. Le lien est sélectionné — copiez-le manuellement.",
  apsShareSheetOpened: "Feuille de partage ouverte.",
