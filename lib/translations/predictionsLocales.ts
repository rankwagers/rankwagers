...
const es: PredictionStrings = mergePredictions({
  ...
  appTitle: "Tu Acca",
  appCountLine: "{n} selecciones · solo boleta de investigación",
  appCloseAria: "Cerrar el panel de Acca",
  appDismiss: "Descartar",
  appUndo: "Deshacer",
  appClearAll: "Borrar todo",
  appCleared: "Acca borrada.",
  appOpenStudio: "Abrir estudio",
  appEmptySlip:
    "Añade selecciones desde las páginas de partido, los mercados clasificados o el explorador de partidos. Solo hay mercados con liquidación soportada.",
  appOddsUnavailable: "cuotas no disponibles",
  appProviderPotential: "potencial del proveedor {pct}% (sin muestra)",
  appMatchDetail: "Detalle del partido",
  appRemove: "Quitar",
  appRemoveAria: "Quitar {home} vs {away}",
  appCombinedOdds: "Cuotas combinadas",
  appIncomplete: "incompleto",
  appRiskClass: "Clase de riesgo",
  appStakeUnits: "Unidades (apuesta base)",
  appPotentialReturn: "Retorno potencial",
  appPotentialProfit: "Beneficio potencial",
  appUnitsNote:
    "Las unidades son cifras de investigación neutras — no una cartera y no una apuesta realizada.",
  appNameLabel: "Nombra esta Acca",
  appNamePlaceholder: "p. ej. Overs del sábado",
  appSaveNamed: "Guardar Acca con nombre",
  appSavedLocally: "Guardado localmente.",
  appCopy: "Copiar",
  appCopied: "Copiado como texto.",
  appTelegramText: "Texto para Telegram",
  appTelegramCopied: "Texto para Telegram copiado.",
  appShareUrl: "URL para compartir",
  appShareCopied: "URL copiada (enlace de restauración noindex).",
  appClipboardUnavailable: "Portapapeles no disponible.",
  appSavedAccas: "Accas guardadas",
  appDelete: "Eliminar",
  appDeleteAria: "Eliminar {name}",
  apbConfigTitle: "Configuración del constructor",
  apbRiskMode: "Modo de riesgo",
  apbAllowedMarkets: "Mercados permitidos",
  apbTargetMin: "Cuota objetivo mín. (opcional)",
  apbTargetMax: "Cuota objetivo máx. (opcional)",
  apbExcludeTeams: "Excluir equipos (separados por comas)",
  apbCompetitionFilter: "Filtro de competición (separado por comas, opcional)",
  apbOnePerFixture: "Una selección por partido",
  apbPrematchOnly: "Solo pre-partido",
  apbGenerate: "Generar Acca",
  apbGenerating: "Generando…",
  apbGeneratingLong: "Generando sugerencias de acumuladas…",
  apbIdleNote:
    "Configura los filtros y genera. Las combinaciones usan predicciones publicadas reales — nunca partidos ni cuotas inventados.",
  apbRanked: "Combinaciones ordenadas",
  apbNoCombo:
    "Ninguna combinación válida con esta configuración. Relaja confianza, mercados o número de selecciones — las puertas de calidad no se bajan automáticamente.",
  apbGenerationFailed: "La generación falló.",
  apbTimeout: "La petición al proveedor caducó. Inténtalo de nuevo.",
  apbNetworkFail: "Fallo de red — comprueba tu conexión e inténtalo de nuevo.",
  apbRecommended: "Recomendada",
  apbSafer: "Alternativa más segura",
  apbHigherRisk: "Alternativa de mayor riesgo",
  apbOddsUnavailable: "Cuotas no disponibles",
  apbAddAll: "Añadir la Acca entera al Studio",
  apbAddOne: "Añadir a las acumuladas",
  apbReplace: "Reemplazar",
  apbCancel: "Cancelar",
  apbWhyLeg: "Por qué esta selección",
  apbWarningsAria: "Advertencias",
  apbAccasUnavailable: "Las acumuladas no están disponibles en esta vista. Abre primero las acumuladas.",
  apbOpenAccas: "Abrir acumuladas",
  apxLede:
    "Combinaciones de varias selecciones formadas desde nuestras listas calificadas, publicadas con su evidencia.",
  apxLede2:
    "Cada una es una combinación determinista de selecciones que ya calificaron para nuestras listas publicadas — nunca una elección manual, y nunca repuntuada después. Su página indica qué selecciones contiene, qué se registró en apoyo de cada una, cuándo se generó y publicó, y si sus partidos ya comenzaron.",
  apxStillAhead: "Aún por delante",
  apxStillAheadNote: "Las más nuevas primero. Al menos un partido de cada una no ha comenzado.",
  apxSettledNote:
    "Todos los partidos de estas ya comenzaron. Siguen publicadas como registro de lo dicho de antemano. Los resultados no se anotan en la página de una Acca — las predicciones individuales liquidadas viven en el archivo.",
  apxNothingFilter: "Nada coincide con ese filtro",
  apxNothingYet: "Nada publicado aún",
  apxNothingFilterDesc:
    "Ninguna Acca publicada coincide con los filtros seleccionados. Bórralos para ver todo lo publicado en este idioma.",
  apxNothingYetDesc:
    "No se han publicado Accas en este idioma. En vez de rellenar con contenido de relleno, la página queda vacía hasta que haya algo real que mostrar.",
  apxOlderNote:
    "Este listado examina las {n} Accas publicadas más recientes de este idioma. Las más antiguas existen en almacenamiento y no se muestran aquí.",
  apxFullBreakdown: "el desglose completo",
  apxFilterProfile: "Perfil",
  apxFilterCompetition: "Competición",
  apxClosed: "Cerradas",
  apxTodaysListsNote: "— las listas de las que se construyen.",
  apxBuilderNote: "— arma la tuya con la misma evidencia.",
  apxArchiveNote: "— resultados liquidados, victorias y derrotas por igual.",
  apxHowBuilt: "Cómo se construyen",
  apxFirstKickoff: "Primer inicio",
  apxLimitationsNoted: "{n} limitaciones anotadas — mira el desglose completo.",
  apxFilterState: "Estado",
  apxPagesAria: "Páginas de Accas publicadas",
  apdAtAGlance: "De un vistazo",
  apdSelections: "Selecciones",
  apdBuilderProfile: "Perfil del constructor",
  apdGenerated: "Generada",
  apdPublished: "Publicada",
  apdState: "Estado",
  apdSelectionsTitle: "Las {n} selecciones",
  apdTableCaption: "Selecciones de esta Acca, con las cuotas capturadas en la publicación",
  apdColFixture: "Partido",
  apdColKickoff: "Inicio (UTC)",
  apdColEvidence: "Evidencia",
  apdColPotential: "Potencial del proveedor",
  apdColOddsAtPub: "Cuotas en la publicación",
  apdCombinedNote:
    "Las cuotas combinadas son el producto de los precios individuales de arriba, calculado con exactitud y redondeado una sola vez. No son una probabilidad ni una estimación de retorno.",
  apdWhyTitle: "Por qué estas selecciones",
  apdWhyNote:
    "Cada selección de abajo ya calificó para nuestras listas publicadas antes de que el constructor la combinara. Despliega una para ver exactamente qué se registró en su momento. Una selección sin nada registrado lo dice — un panel vacío es un hueco en el registro, no un respaldo silencioso.",
  apdQualification: "Calificación",
  apdQualifiedLine:
    "Pasó las puertas de confianza, frescura, conflicto y evidencia del constructor cuando se generó la combinación.",
  apdPriceRecorded: "Precio registrado",
  apdProvenance: "Procedencia",
  apdBuiltOn: "Sobre qué se construyó",
  apdNoAggregateNotes: "No se registraron notas de evidencia agregadas para esta combinación.",
  apdWithPotential: "Selecciones con potencial del proveedor",
  apdAvgPotential: "Potencial medio del proveedor",
  apdCompleteness: "Completitud de la evidencia",
  apdProvenanceTitle: "Procedencia y frescura de los datos",
  apdWithReasons: "Selecciones con razones escritas",
  apdOddsCaptured: "Cuotas capturadas",
  apdPriceAge: "Antigüedad del precio",
  apdPublicationFormat: "Formato de publicación",
  apdOfCount: "{a} de {b}",
  apsLinkCopied: "Enlace copiado al portapapeles.",
  apsClipboardManual:
    "El portapapeles no está disponible aquí. El enlace está seleccionado — cópialo manualmente.",
  apsShareSheetOpened: "Hoja de compartir abierta.",
