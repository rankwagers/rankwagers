...
/* Route-level error state for the search family — form-guide idiom. Honest and
...
export default function SearchError({
  ...
  useEffect(() => {
    reportError(error, "search_error_boundary", {
    ...
    <div className="rw-hero container-wide bg-[var(--hero-canvas)] pb-24">
      ...
      >
        ...
        <p className="mt-4 max-w-md text-sm leading-relaxed text-[var(--hero-ink-2)]">
          A temporary error interrupted the search view. Nothing in the
