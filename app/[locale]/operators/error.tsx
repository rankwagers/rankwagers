...
/* Route-level error state for the operators family — form-guide idiom. Honest and
...
export default function OperatorsError({
  ...
  useEffect(() => {
    reportError(error, "operators_error_boundary", {
  ...
  return (
    <div className="rw-hero container-wide bg-[var(--hero-canvas)] pb-24">
      <div
        ...
        role="alert"
      >
        <p className="rw-label">Operators</p>
        ...
        <p className="mt-4 max-w-md text-sm leading-relaxed text-[var(--hero-ink-2)]">
          A temporary error interrupted the operators view. Nothing in the
